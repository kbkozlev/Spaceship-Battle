...
pygame.display.set_caption("Spaceship Battle v1.0")
...
DEV_FONT = pygame.font.SysFont('comicsans', 20)
START_FONT = pygame.font.SysFont('comicsans', 35)
...
def start_game():
    ...
    while run:
        ...
        WIN.blit(SPACE, (0, 0))
        name_text = NAME_FONT.render("Spaceship Battle v1.0", True, WHITE)
        start_text = START_FONT.render("Press Enter to start the game", True, WHITE)
        dev_text = DEV_FONT.render("Created by kbkozlev", True, WHITE)
        WIN.blit(name_text, (WIDTH / 2 - name_text.get_width() / 2, HEIGHT - name_text.get_height() - 350))
        WIN.blit(start_text, (WIDTH / 2 - start_text.get_width() / 2, HEIGHT / 2 - start_text.get_height() / 2))
        WIN.blit(dev_text, (WIDTH / 2 - dev_text.get_width() / 2, HEIGHT - dev_text.get_height() - 50))
...
def main():
    red = pygame.Rect(760, 220, SPACESHIP_HEIGHT, SPACESHIP_WIDTH)
    yellow = pygame.Rect(100, 220, SPACESHIP_HEIGHT, SPACESHIP_WIDTH)
